  ...
  <nav>
    <div id="set-controls">
      <div id="iconset-attr-grid">
        ...
        <label for="supported-orientations">{'支持'}</label>
        ...
        <button on:click={() => exportIconset()}>{'导出图标集'}</button>
      </div>
    </div>
  ...
  {#if selectedIcon}
    <section id="icon-preview">
      ...
      <div id="preview-controls">
        ...
        <button
          ...
          title={'复制这个六角格'}
        >
          <img src="/assets/img/tools/duplicate.png" alt="复制图标" />
        </button>
        <button
          on:click={() => {
    ...
    <aside id="icon-style">
      ...
      <div class="scale-holder">
        <label for="icon-builder-rotation">{'旋转'}</label>
      ...
      <div id="symbol-scale">
        <div class="builder-control-row">
          <label for="icon-scale-mode">{'图标缩放'}</label>
          <select
            id="icon-scale-mode"
      ...
      {#if selectedIcon.scaleMode === ScaleMode.RELATIVE}
        <div class="scale-holder">
          <label for="icon-builder-scale-relative">{'占六角格比例'}</label>
      ...
      {:else if selectedIcon.scaleMode === ScaleMode.BYDIMENSION}
        <div>
          <div class="scale-holder">
            <label for="icon-builder-scale-2d-width">{'宽度的百分比'}</label>
          ...
          <div class="scale-holder">
            <label for="icon-builder-scale-2d-height">{'高度的百分比'}</label>
